...
from calibre.ebooks.pdf.image_writer import (Image, PDFMetadata,
                                             draw_image_page, get_page_layout)
...
from polyglot.builtins import (as_bytes, as_unicode, filter, iteritems, map,
                               range, unicode_type)
from polyglot.urllib import urlparse
from PyQt5.Qt import (QApplication, QMarginsF, QObject, QPageLayout, Qt,
...
class RenderManager(QObject):
    ...
    def __init__(self, opts, log, container_root):
        ...
        ## PATCH START
        # See: https://bugs.debian.org/cgi-bin/bugreport.cgi?att=1;bug=944875;filename=944875.diff;msg=20
